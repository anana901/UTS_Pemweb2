        ...
        <div class="row">
          <div class="col-12">
            ...
            <div class="card">
              <!-- /.card-header -->
              <div class="card-body">
                <a href="create_produk.php" class="btn btn-success" style="margin-bottom: 5px;">Tambah Produk</a>
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tr>
                    ...
                    <td>10</td>
                    <td>5</td>
                    <td>AC atau air conditioner merupakan perangkat elektronik yang berfungsi sebagai pendingin ruangan ini menjadi solusi jitu mengatasi udara yang panas.</td>
                    <td>1</td>
                    <td>
